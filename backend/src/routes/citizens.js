...
router.get('/notifications/inbox/unread-count', citizenController.getUnreadCount);
router.get('/notifications/inbox/:notificationId', citizenController.getNotificationDetail);
...
router.get('/delivery-log', authorizePermission('citizens', 'read'), citizenController.getDeliveryLog);
